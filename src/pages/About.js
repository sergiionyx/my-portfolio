      ...
      <div className="container m-2">
        ...
        <div className="text-div">
          <h3 className="fs-5">
            ...
            <br></br>&nbsp;&nbsp;&nbsp;My excellent work ethic has
            provided me with many opportunities to accomplish goals that have
            earned me recognition at work. Some of these accomplishments
            include: wrote numerous unit and API tests, developed web design
            solutions and applications, resolved more than 50 critical bugs to
            improve performance and user experience. I am confident that you
            will find my hands-on experience; qualifications and proficiencies
            make me an excellent candidate for the Full Stack Developer position
            at any company.
            <br></br>&nbsp;&nbsp;&nbsp;Thank you for your time. Please let me know if there
            is anything you need from me by checking the Contact.
            {/* 
