    ...
    <div className="container" style={{ textAlign: "center" }}>
      ...
      <div className="col">
        ...
        <div className="card-container">
          ...
          <div className="card">
            <h4>Pizza Maker</h4>
            <p>An app where users can create their favorite pizzas with whatever toppings they wish and can comment on the creations of others.</p>
            <span className="chev">&rsaquo;</span>
          </div>
        </div>
        {/* 3.1
      ...
      <div className="col">
        ...
        <div className="card-container">
          ...
          <div className="card">
            ...
            <span className="chev">&rsaquo;</span>
            <p>
              National Park Picker is a platform made to explore and plan visits
              to National Parks within the USA
            </p>
          </div>
        </div>
        ...
        <div className="card-container">
          ...
          <div className="card">
            <h4>Note Tacker</h4>
            <p>Note Taker is a program that allows a user to write, keep, and delete notes.</p>
            <span className="chev">&rsaquo;</span>
          </div>
        </div>
        ...
        <div className="card-container">
          ...
          <div className="card">
            ...
            <p>
              ...
              their posts revolving around the world of technology. Users are
              able to create accounts with secure passwords allowing them to
        ...
        <div className="card-container">
          ...
          <div className="card">
            ...
            <p>
              ...
              deposits with or without a data/internet connection. And by that
              it's make account balance is accurate in traveling
            </p>
            {/* <span className="chev">&rsaquo;</span> */}
          </div>
        </div>
